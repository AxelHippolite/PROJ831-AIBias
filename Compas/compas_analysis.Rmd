...
merged_data <- subset(merged_data, select = c(MaritalStatus, CustodyStatus, LegalStatus, age_cat, sex, priors_count, is_recid, days_b_screening_arrest, c_charge_degree, race, Language, DecileScore))
...
The predictions of our new model are quite good. We obtain an accuracy of 75%.
