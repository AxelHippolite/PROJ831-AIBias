...
The actual distribution of ethnicities in recidivism is roughly consistent with our observations of each ethnicity's risk of recidivism. The ethnicities with the highest recidivism rates are African Americans and Native Americans, although African-Americans are much more represented in the dataset. Caucasian individuals (considered white people) are better represented in the dataset. The proportion of Caucasian recidivists is 10% lower than African Americans. Keep in mind that the data in the dataset is based on actual arrests by the US police. Gender or racial bias may therefore come from the dataset itself, which may explain the wide disparity in the distribution of individuals.
